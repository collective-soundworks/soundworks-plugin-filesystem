...
describe(`PluginFilesystem`, () => {
  describe('[server]', async () => {
    describe('#constructor(server, id, options)', async () => {
    ...
    describe('#findInTree(path, tree = null) -> TreeNode', () => {
    ...
    describe(`#onUpdate(updates => {}, executeListener = false) -> unsubscribe`, () => {
    ...
    describe('#writeFile(filename, content)', () => {
